    ...
    <div className="min-h-screen">
      ...
      <aside className="glass-sidebar fixed left-0 top-0 w-64 h-full flex flex-col z-40">
        ...
        <nav className="flex-1 p-3 space-y-0.5 overflow-y-auto">
          ...
          <a href="/dashboard/keys" className="sidebar-item">
            <svg className="sidebar-icon" viewBox="0 0 16 16" fill="currentColor">
          ...
          <a href="/dashboard/logs" className="sidebar-item">
            <svg className="sidebar-icon" viewBox="0 0 16 16" fill="currentColor">
          ...
          <a href="/dashboard/billing" className="sidebar-item">
            <svg className="sidebar-icon" viewBox="0 0 16 16" fill="currentColor">
          ...
          <a href="/dashboard/tickets" className="sidebar-item">
            <svg className="sidebar-icon" viewBox="0 0 16 16" fill="currentColor">
