...
export function registerGbpGetPostsTool(server: McpServer, user: UserContext): void {
  server.tool(
    "gbp_get_posts",
    ...
    async (params) => {
      ...
      try {
        ...
        const rawPosts = await getGbpPosts(accessToken, params.location_name, params.page_size);
